...
final class PaywallFunnelTests: XCTestCase {
    ...
    func testCountsPitchesPerSurfaceAndInTotal() {
        ConversionDiagnostics.recordPitchView(impressionID: "shoeson_paywall")
        ConversionDiagnostics.recordPitchView(impressionID: "shoeson_paywall")
        ConversionDiagnostics.recordPitchView(impressionID: "shoeson_onboarding_trial")
    ...
    func testAttributeKeysStayInsideRevenueCatsLimit() {
        ...
        ConversionDiagnostics.recordPitchView(impressionID: "shoeson_\(long)")
