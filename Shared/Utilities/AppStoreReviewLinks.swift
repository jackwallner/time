...
/// App Store review deep links for Shoes On.
enum AppStoreReviewLinks {
    /// App Store Connect record for com.jackwallner.time.
    static let appStoreID = "6814953557"
...
enum ShoesOnLinks {
    static let privacyPolicy = URL(string: "https://jackwallner.github.io/time/privacy-policy.html")!
    static let support = URL(string: "https://jackwallner.github.io/time/support.html")!
