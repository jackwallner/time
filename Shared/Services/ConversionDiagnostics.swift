...
/// On-device record of how someone met Shoes On Pro before they bought it: which
...
enum ConversionDiagnostics {
    private static let logger = Logger(subsystem: "com.jackwallner.time", category: "Conversion")
    ...
    static let suiteName = "group.com.jackwallner.time"
    ...
    private static let impressionPrefix = "shoeson_"
